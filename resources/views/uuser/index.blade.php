          ...
          <table id="table-kk" class="table table-striped">
              ...
              @foreach($users as $user)
                  <tr>
                      ...
                      <td>{{ $user->email }}</td>
                      <td>
                        <a href="{{ route('uuser-edit', ['uuser' => $user->nrp]) }}" role="button" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                        <a href="{{ route('uuser-delete', ['uuser' => $user->nrp]) }}" role="button" class="btn btn-danger btn-delete"><i class="fas fa-trash"></i></a>
                      </td>
                  </tr>
              @endforeach
              </tbody>
